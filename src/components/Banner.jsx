...
export default function Banner() {
  ...
  const handleClickverify = () =>{
    ...
    return(
        <>{(showPopupadd && <Addemployeedetail  />) || (showPopupupdate && <Updateemployeedetail/>) || (showPopupverify && <Verifyemployeedetail/>)}<div className='bg-black w-full py-[170px] flex px-20 ' >
          show?
        ...
        </Card>: <Card color="green" variant="gradient" className="w-full max-w-[20rem]  m-12 p-8 ">
          <CardHeader
            floated={false}
            shadow={false}
            color="transparent"
